        ...
        <div className=" bg-[#ffffff] w-full h-auto sm:w-3xl sm:h-8/12 md:w-7/12 lg:w-2/12 flex flex-col rounded-xl border " >
            <div className="flex-2 flex flex-col">
                <div className=" flex-1 flex justify-between items-center px-3 mt-2">
                    <div className=" text-xl font-bold flex items-center gap-y-2 bg-red-500 px-4 py-2 text-white rounded-xl"><label className="font-semibold text-xl">{product.price}</label> <IndianRupee size={20} /></div>
                ...
                <div className=" flex-6 flex flex-col  items-center ">
                    <img src={product.url} alt="" className=" h-50 w-50" />
                    <div className="w-full flex items-center justify-center px-10 mt-20 ">
                        <label className=" text-xs font-bold">{product.product_name}</label>
                        <label className=" text-xs font-bold">(per {product.unit})</label>
                    </div>
                </div>
            </div>
